...
spotLight.angle = Math.PI / 6; // Angle of the spotlight
...
spotLight1.castShadow = true; // Enable shadow casting
spotLight1.angle = Math.PI / 6; // Angle of the spotlight
spotLight1.penumbra = 0.1; // Soft edge of the spotlight
spotLight1.decay = 2; // Decay of the spotlight
spotLight1.distance = 100; // Distance of the spotlight
scene.add(spotLight);
// Add a helper for the spotlight
const spotLightHelper1 = new THREE.SpotLightHelper(spotLight1, 0xff0000); // Red color for the helper
