...
directionalLight2.position.set(0, -10, 0).normalize();
...
const directionalLightHelper = new THREE.DirectionalLightHelper(directionalLight, directionalLight2, 1); // 1 is the size of the helper
