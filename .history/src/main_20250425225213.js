...
spotLight.decay = 5; // Decay of the light
spotLight.distance = 10; // Distance of the light
...
spotLight1.angle = Math.PI / 4; // Angle of the spotlight
spotLight1.penumbra = 0.5; // Soft edge of the spotlight
spotLight1.decay = 5; // Decay of the light
spotLight1.distance = 10000; // Distance of the light
spotLight1.position.set(0, 0, 1);
spotLight1.target.position.set(0, 0, 0); // Target position
scene.add(spotLight1);
scene.add(spotLight1.target);

const spotLight2 = new THREE.SpotLight(0xffffff, 1);
spotLight2.angle = Math.PI / 4; // Angle of the spotlight
spotLight2.penumbra = 0.5; // Soft edge of the spotlight
spotLight2.decay = 5; // Decay of the light
spotLight2.distance = 10; // Distance of the light
spotLight2.position.set(-1, -0.5, -1);
...
const reflectiveMaterial = new THREE.MeshStandardMaterial({
  ...
  roughness: 0.5 // Slightly smooth for reflectivity
});
